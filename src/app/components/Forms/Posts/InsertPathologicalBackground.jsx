  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <div className="space-y-4">
          {[
            { label: "Hospitalización previa", name: "previousHospitalization" },
            { label: "Cirugías previas", name: "previousSurgeries" },
            ...
            { label: "Transfusiones", name: "transfusions" },
            { label: "Enfermedades respiratorias", name: "respiratoryDiseases" },
            { label: "Enfermedades gastrointestinales", name: "gastrointestinalDiseases" },
            { label: "ETS (Enfermedades de transmisión sexual)", name: "stDs" },
          ...
          {formData.stDs && (
            <Textarea
              ...
              name="stDsData"
              value={formData.stDsData}
              onChange={(e) => setFormData({ ...formData, stDsData: e.target.value })}
              placeholder="Escribe aquí los detalles de ETS..."
            />
          )}
